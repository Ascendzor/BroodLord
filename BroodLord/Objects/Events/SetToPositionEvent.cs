...
{
    [Serializable()]
    public class SetToPositionEvent : Event
    {
        public Vector2 Position;

        public SetToPositionEvent(Guid id, Vector2 position)
        {
            this.Type = 12;
            this.Id = id;
        ...
        public static MoveToPositionEvent Deserialize(byte[] bytes)
        {
            ...
            return new MoveToPositionEvent(new Guid(idBytes), new Vector2(x, y));
        }
    }
}

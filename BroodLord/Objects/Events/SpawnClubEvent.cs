...
{
    [Serializable()]
    public class SpawnClubEvent : Event
    {
        public Guid WoodId;
        public Vector2 Position;

        public SpawnClubEvent(Guid id, Vector2 position)
        {
            this.Type = 3;
            this.Id = id;
        ...
        public static SpawnClubEvent Deserialize(byte[] bytes)
        {
            ...
            return new SpawnClubEvent(new Guid(idBytes), new Vector2(x, y));
        }
    }
}

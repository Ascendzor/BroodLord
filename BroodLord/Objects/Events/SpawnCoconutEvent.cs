...
{
    [Serializable()]
    public class SpawnCoconutEvent : Event
    {
        public Guid WoodId;
        public Vector2 Position;

        public SpawnCoconutEvent(Guid id, Vector2 position)
        {
            this.Type = 9;
            this.Id = id;
        ...
        public static SpawnCoconutEvent Deserialize(byte[] bytes)
        {
            ...
            return new SpawnCoconutEvent(new Guid(idBytes), new Vector2(x, y));
        }
    }
}

...
{
    [Serializable()]
    public class SpawnFlintEvent : Event
    {
        public Guid WoodId;
        public Vector2 Position;

        public SpawnFlintEvent(Guid id, Vector2 position)
        {
            this.Type = 3;
            this.Id = id;
        ...
        public static SpawnFlintEvent Deserialize(byte[] bytes)
        {
            ...
            return new SpawnFlintEvent(new Guid(idBytes), new Vector2(x, y));
        }
    }
}

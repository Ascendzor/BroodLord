...
{
    [Serializable()]
    public class SpawnRockEvent : Event
    {
        public Guid RockId;
        public Vector2 Position;

        public SpawnRockEvent(Guid id, Vector2 position)
        {
            this.Type = 4;
            this.Id = id;
        ...
        public static SpawnRockEvent Deserialize(byte[] bytes)
        {
            ...
            return new SpawnRockEvent(new Guid(idBytes), new Vector2(x, y));
        }
    }
}
